(function(window, undefined) {
    ...
    "lib/logger";
    define("/lib/logger", [ "require", "exports", "module" ], function(require, exports, module) {
        /* jshint evil: true */
        /* global chrome:true */
        "use strict";
        module.exports.log = function(msg) {
            chrome.devtools.inspectedWindow.eval("console.debug(" + JSON.stringify(msg) + ")", function() {});
        };
    })
    ...
    define("/sear-chrome", [ "require", "exports", "module", "/lib/connection", "/lib/logger", "/manifest.json", "/underscore/underscore" ], function(require, exports, module) {
        ...
        SearChrome.prototype.clean = function() {
            if (this._initialized) {
                this.resources = [];
                chrome.devtools.inspectedWindow.onResourceAdded.removeListener(this._resourceAdded);
                this._initialized = false;
            }
        };
        ...
        SearChrome.prototype.liveUpdatePath = function(callback) {
            var self = this;
            chrome.devtools.inspectedWindow.eval("(function () { return " + 'JSON.stringify({path: window.sear_live_update ? ("ws://" + ' + "location.host.toString() + " + "window.sear_live_update + " + '"/websocket")  : "", root: location.protocol + "//" + location.host});' + "})()", function(value, isEx) {
        ...
        SearChrome.prototype.initPanel = function() {
            ...
            chrome.devtools.panels.create("Sear", "", "config/index.html", function(panel) {
                self.panel = panel;
            });
        };
            ...
            _.find(this.resources, function(res) {
                ...
                if (module.replace(/\.js$/, "") === resUrl.replace(/\.js$/, "")) {
                    ...
                    res.setContent(command.source, true, function(status) {
                        chrome.devtools.inspectedWindow.eval("window.dispatchEvent(" + 'new CustomEvent("sear_update", {' + 'detail: "' + module + '"' + "}));", function() {
                            callback(status);
                        });
                    });
                    return true;
